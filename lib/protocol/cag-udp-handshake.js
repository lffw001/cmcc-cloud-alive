...
async function runCagUdpHandshake(auth = {}, opts = {}) {
  ...
  const report = {
    ...
    localKey: {
      ...
      flagsHex: localKey.parsed.ztecOpentelemetryKeyInfo
        ? hex32(localKey.parsed.ztecOpentelemetryKeyInfo.flags)
        : '',
      baseFlags: localKey.parsed.ztecOpentelemetryKeyInfo
        ? localKey.parsed.ztecOpentelemetryKeyInfo.flags & 0xffff
        : undefined,
      transportFlag: localKey.parsed.ztecOpentelemetryKeyInfo?.transportFlag,
      addressFamilyFlag: localKey.parsed.ztecOpentelemetryKeyInfo?.addressFamilyFlag,
